...
# cell 1
using NonlinearSolve,Plots, Latexify, LinearAlgebra, Symbolics, LaTeXStrings,Markdown
...
# ╔═╡ d185ecdc-7e33-4b54-a8b0-e6bb89fee2e8
begin
    @variables x_1 y_1 θ_1 x_2 y_2 θ_2 x_3 y_3 θ_3 t

    # Build symbolic q vector (same structure as numeric one)
    qsym = [
        x_1, y_1, θ_1,
        x_2, y_2, θ_2,
        x_3, y_3, θ_3
    ...
    constraints!(Csym, qsym, t)

    [
        md"## Constraint Equations (from Cell 4)",
        L"q = [x_1,\; y_1,\; \theta_1,\; x_2,\; y_2,\; \theta_2,\; x_3,\; y_3,\; \theta_3]",
        latexify(Csym .~ 0)
    ]
end
...
anim = @animate for i in 1:size(Q, 2)
    ...
    plot(
        ...
        color = :black,
        lw = 1,
		title="Rigid Bar Motion with Sliding Pins Animation"
    )
...
manifest_format = "2.0"
project_hash = "9b0d3369ecfb633a786144cc6434f0f1e851dc79"

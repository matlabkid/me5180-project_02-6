...
# ╔═╡ 45876bcd-20e6-4466-a3f8-f3172e6bf639
begin
	@gif for i in 1:length(time_span)
	    ...
	    plot(xlim=(-0.15,0.15), ylim=(-0.15,0.15),
	         aspect_ratio=:equal, legend=false)
	    # Tracks
	    plot!([-0.2, 0.2], [-0.2, 0.2], linewidth=2, color=:black)
	    plot!([-0.2, 0.2], [ 0.2,-0.2], linewidth=2, color=:black)
...
# ╔═╡ 7331e030-0d7e-4288-8ffc-17e3a43cbadf
begin
println("Example at t = 0:")
println("Positions: ", position_solution[1,:])
println("Velocities: ", velocity_solution[1,:])
println("Accelerations: ", acceleration_solution[1,:])
end
